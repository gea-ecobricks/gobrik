...
<div id="footer-full">
		...
		<div class="footer-bottom">
			...
			<div class="footer-invite">
				GoBrik is open source and 100% volunteer built!<br>Contribute on <a href="https://github.com/gea-ecobricks/gobrik/blob/master/index.html" target="_blank">Github</a>.<br><br>GoBrik PHP server.  Testing the php: <?php echo ($dist); ;?>
