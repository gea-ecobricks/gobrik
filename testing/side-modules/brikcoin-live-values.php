...
$result = $conn->query($sql);
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo '<img src="https://ecobricks.org/svgs/aes-brk.svg?v=2" style="width:65%; margin-top:20px;"><p style="font-size: 1.2em; margin-top:5px;">Current value of 1 Brikcoin:</p>
            ...
            <p><a class="module-btn" href="go.php#offset">Buy Plastic Offsets</a></p>
           </div>' ; 
